...
class Criminal:
    def __init__(self,root):
        ...
        lbl_title.place(x=0,y=0,width=1367,height=70)

        #ncr logo
        img_logo=Image.open('images/ncrlogo.jpeg')
        img_logo=img_logo.resize((60,60))
        self.photo_logo=ImageTk.PhotoImage(img_logo)

        self.logo=Label(self.root,image=self.photo_logo)
        self.logo.place(x=140,y=5,width=60,height=60)

         #Imgframe
        img_frame=Frame(self.root,bd=3,relief=RIDGE,bg='white')
        img_frame.place(x=0,y=70,width=1530,height=140)

        img1=Image.open('images/police3.png')
        img1=img1.resize((540,160),Image.BICUBIC)
        self.photo1=ImageTk.PhotoImage(img1)

        self.img_1=Label(img_frame,image=self.photo1)
        self.img_1.place(x=0,y=0,width=500,height=130)
        
        
        #2nd
        img_2=Image.open('images/cyber crime.jpeg')
        img_2=img_2.resize((540,160),Image.BICUBIC)
        self.photo2=ImageTk.PhotoImage(img_2)

        self.img_2=Label(img_frame,image=self.photo2)
        self.img_2.place(x=510,y=0,width=430,height=130)
        
        #3rd 
        img_3=Image.open('images/police3.png')
        img_3=img_3.resize((540,160),Image.BICUBIC)
        self.photo3=ImageTk.PhotoImage(img_3)

        self.img_3=Label(img_frame,image=self.photo3)
        self.img_3.place(x=950,y=0,width=500,height=130)

        #Main frame
        Main_frame=Frame(self.root,bd=2,relief=RIDGE,bg='white')
        Main_frame.place(x=0,y=210,width=1365,height=560)
        ...
        upper_frame.place(x=5,y=3,width=1350,height=270)
        ...
        # Criminal No
        lbl_crminal_no=Label(upper_frame,font=('arial',12,"bold"),text='Criminal No:',bg='white')
        lbl_crminal_no.grid(row=0,column=2,sticky=W,padx=2,pady=7)

        txt_crminal_no=ttk.Entry(upper_frame,textvariable=self.var_criminal_no,width=22,font=('arial',11,'bold'))
        txt_crminal_no.grid(row=0,column=3,padx=2,pady=7)
        ...
        txt_arrestDate=ttk.Entry(upper_frame,textvariable=self.var_arrest,width=22,font=("arial",11,"bold"))
        ...
        txt_dataofCrime=ttk.Entry(upper_frame,textvariable=self.var_date_of_crime,width=22,font=("arial",11,"bold"))
        txt_dataofCrime.grid(row=2,column=3,sticky=W,padx=2,pady=7)
        ...
        button_frame.place(x=5,y=200,width=627,height=45)
        ...
        img_crime=Image.open('images/crime gif.png')
        img_crime=img_crime.resize((540,160),Image.BICUBIC)
        self.photocrime=ImageTk.PhotoImage(img_crime)

        self.img_crime=Label(upper_frame,image=self.photocrime)
        self.img_crime.place(x=950,y=30,width=390,height=170)
        ...
        down_frame.place(x=5,y=280,width=1350,height=200)

        search_frame=LabelFrame(down_frame,bd=1,relief=RIDGE,text='Search Criminal Record ',font=('times new roman',11,'bold'),fg='red',bg='white')
        search_frame.place(x=7,y=0,width=1331,height=63)
        ...
        table_frame.place(x=7,y=70,width=1331,height=100)
    ...
    def add_data(self):
        if self.var_case_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Ayesha@9833',database='management')
